...
function hotkeys:init(args)
	...
	local layout_grid_resize = {
		...
		{
			{ env.mod }, "j", function() grid.resize_to("up", nil, true) end,
			{ description = "Decrease window size from the up", group = "Resize" }
		},
		{
			{ env.mod, "Shift" }, "j", function() grid.resize_to("down") end,
		...
		{
			{ env.mod }, "l", function() grid.resize_to("left", nil, true) end,
			{ description = "Decrease window size from the left", group = "Resize" }
		},
		{
			{ env.mod, "Shift" }, "l", function() grid.resize_to("right") end,
